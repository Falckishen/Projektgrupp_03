...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        new KeyboardInput(mainMenu, gameView.getFrameRootPane());
        //new KeyboardInput(gameView.getFrameRootPane(), mainMenu.getMovementInputList(), mainMenu, mainMenu.getWeaponInputList());
